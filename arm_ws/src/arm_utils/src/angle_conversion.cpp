...
public:
    ...
    {
        euler_to_quaternion_ = create_service<arm_msgs::srv::EulerToQuaternion>("euler_to_quaternion", 
            std::bind(&AnglesConverter::eulerToQuaternionCallback, this, _1, _2));
        quaternion_to_euler_ = create_service<arm_msgs::srv::QuaternionToEuler>("quaternion_to_euler", 
...
private:
    ...
    void eulerToQuaternionCallback(const std::shared_ptr<arm_msgs::srv::EulerToQuaternion::Request> req,
                                   const std::shared_ptr<arm_msgs::srv::EulerToQuaternion::Response> res)
    {
    ...
    void quaternionToEulerCallback(const std::shared_ptr<arm_msgs::srv::QuaternionToEuler::Request> req,
                                   const std::shared_ptr<arm_msgs::srv::QuaternionToEuler::Response> res)
    {
