...
public:
    ...
    {
        service_ = create_service<arm_msgs::srv::AddTwoInts>("add_two_ints", std::bind(&SimpleServiceServer::serviceCallback, this, _1, _2));
...
private:
    ...
    void serviceCallback(const std::shared_ptr<arm_msgs::srv::AddTwoInts::Request> req,
                         const std::shared_ptr<arm_msgs::srv::AddTwoInts::Response> res)
    {
